...
/* REPLACE END: _move */
	...
	_end: function (e) {
		...
		if (this.directionLocked != 'v' && this._events.flick && duration < 350 && distanceX > 10 && distanceX < 250 && distanceY < 100 ) { // MOD Ayat (was the prev line)
		...
		if ( this.options.snap ) {
			...
			if(this.options.snapY){ // MOD Ayat (added this option)s
				newY = snap.y;
			}
